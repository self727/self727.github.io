...
/* eslint-disable */
const API_ROOT = 'http://ci3.com/index.php'
const API_ROOT_DEV = '/localapi'


/* eslint-enable */
axios.defaults.baseURL = (process.env.NODE_ENV === 'production' ? API_ROOT : API_ROOT)
...
export default {
  ...
  uploadToQiniu (params) {
    return axios.post('http://ci3.com/index.php/admin/upload', params, {
      headers: {
